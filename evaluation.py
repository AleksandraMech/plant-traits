...
MODEL_NAME = 'swin_small_patch4_window7_224' # 'swin_large_patch4_window12_384.ms_in22k_ft_in1k'
NUM_CLASSES = 6
BATCH_SIZE = 32
NUM_WORKERS = 4
...
if __name__ == '__main__':
    ...
    mean_cols = ['X4_mean', 'X11_mean', 'X18_mean', 'X50_mean', 'X26_mean', 'X3112_mean']
    std_cols = ['X4_sd', 'X11_sd', 'X18_sd', 'X50_sd', 'X26_sd', 'X3112_sd']
    global_means = train_df[mean_cols].mean(axis=0).values
    global_stds = train_df[std_cols].mean(axis=0).values 
