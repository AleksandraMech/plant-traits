...
def train_model(train_df, val_df, normalize_targets=None):
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        train_preds_denorm = train_preds * normalize_targets['std'] + normalize_targets['mean']
        train_targets_denorm = train_targets * normalize_targets['std'] + normalize_targets['mean']
        ...
        val_preds_denorm = val_preds * normalize_targets['std'] + normalize_targets['mean']
        val_targets_denorm = val_targets * normalize_targets['std'] + normalize_targets['mean']
